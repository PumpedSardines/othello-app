...
var _asc = require("assemblyscript/cli/asc");
...
var _optionsUtils = require("./optionsUtils");

var _optionsUtils2 = _interopRequireDefault(_optionsUtils);
...
function loader(source) {
    ...
    var params = [_path2.default.relative(process.cwd(), this.resourcePath), "-o", _path2.default.relative(process.cwd(), targetPath)
    // ,
    // "--optimize",
    // "--validate",
    // "--sourceMap"
    ];
    (0, _optionsUtils2.default)(params, options);
    _asc2.default.main(params, function (err) {
        if (err) throw err;
